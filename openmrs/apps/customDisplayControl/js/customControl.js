...
angular.module('bahmni.common.displaycontrol.custom')
    ...
    return {
        ...
        template:
            ...
            '<ul><li ng-repeat="chiefComplaint in observations.groupMembers" style="padding-bottom: 5px; padding-top: 2px;">' +
    ...
    return {
        ...
        template:
            ...
            '<span style="font-size: 16px;" ><b>Physical Examination</b></span> <br>' +
            '<ul><li ng-repeat="results in physicalExamObs.groupMembers" style="padding-bottom: 3px; padding-top: 2px;">' +
        ...
        function ($q, observationsService, appService, $http) {
            ...
            return {
                ...
                template: '<div style="padding-bottom: 10px" ng-if="obsDiagnosis.length>0"> <br>' +
                    '<span style="font-size: 16px; ; padding-bottom: 3px;" ><b>Clinical Diagnosis</b></span>' +
                    '<span style="padding-top: 2px;"><ul>\n' +
                    '        <li ng-repeat="obsGroup in obsDiagnosis">\n' +
                    '            <span style="padding-left: 5px;padding-top: 6px"><b> {{$index + 1}}. </b>{{obsGroup.codedAnswer.name}}</span>\n' +
                    '        </li>\n' +
                    '    </ul></span></div>',
            }
        }])
    .directive('medicationTemplate', ['appService', 'treatmentService', 'visitService', 'spinner', '$sce', function (appService, treatmentService, visitService, spinner, $sce) {
        ...
        return {
            restrict: 'E',
            link: link,
            template: '<span style="font-size: 16px;; padding-bottom: 5px;" ng-if="drugOrders.visitDrugOrders.length>0"><b>Rx</b></span><br>' +
                '<div ng-repeat="drugOrder in drugOrders.visitDrugOrders" style="padding-top:2px; font-size: 13px">\n' +
        ...
        function (appService, labOrderResultService, treatmentService, visitService, spinner, $http) {
            ...
            return {
                ...
                template: '<div ng-if="investigationResults.length>0">' +
                    ' <span style="font-size: 16px; padding-bottom: 5px;" ><b> Investigations </b></span>' +
    ...
    .directive('adviceTemplate', ['observationsService', 'appService', 'spinner', function (observationsService, appService, spinner) {
        ...
        return {
            ...
            template: '<div style="padding-bottom: 5px" ng-if="obsAdvice"> <br>' +
                '<span style="font-size: 16px" ><b>Advices</b></span> <br>' +
